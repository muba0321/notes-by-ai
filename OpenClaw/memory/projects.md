...
| 节点 | 地址 | 状态 | 说明 |
|------|------|------|------|
| 子节点 2 | localhost:9100 | ✅ up | 监控中心本地 |
...
**工作流程：**
```
子节点 2 (生成) → 主节点 (归档) → GitHub 备份
```

| 节点 | 角色 | 路径 |
|------|------|------|
| **子节点 2** | 生成产品文档 | `/root/.openclaw/workspace/products/` |
...
|----------|----------|----------|----------|----------|
| **新服务部署** | 服务部署方案规范模板 | 完整填写 11 章 | 子节点 2 复核 → 用户确认 | `服务方案/` |
| **常规变更** | 常规变更单模板 | 填写变更内容、回滚方案 | 子节点 2 复核 → 用户确认 | `变更单/` |
...
| K8s 部署方案 | `CI-CD/服务方案/K8s-部署方案-v1.1.md` | v1.1 | 子节点 2 已复核 |
